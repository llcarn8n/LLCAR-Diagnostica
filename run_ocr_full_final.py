"""Full OCR: CPU-first model load (proven working), process all 352 tables."""
...
# ===== Load model: CPU first, then GPU (bypasses device_map crash) =====
...
# Run
print('\n=== FULL OCR (352 tables, CPU->GPU load, bfloat16+eager) ===')
t0 = time.time()
...
if exit_code == 0:
    ...
    print('Check workstation for errors')
